...
/** Change event object emitted by CustomSelect. */
export class CustomDateChange {
  constructor(public source: CustomDatepicker, public value: Date) { }
}
 ...
 * CustomCalendar directly as the content so we can control the initial focus. This also gives us a
...
@Component({
  moduleId: module.id,
  selector: 'Custom-datepicker-content',
  templateUrl: 'datepicker-content.html',
  styleUrls: ['datepicker-content.scss'],
  host: {
    'class': 'Custom-datepicker-content',
    '[class.Custom-datepicker-content-touch]': 'datepicker?.touchUi',
    '(keydown)': '_handleKeydown($event)',
  },
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class CustomDatepickerContent {
  datepicker: CustomDatepicker;

  @ViewChild(CustomCalendar) _calendar: CustomCalendar;
...
@Component({
  ...
  providers: [Custom_DATEPICKER_VALUE_ACCESSOR, Custom_DATEPICKER_VALIDATORS],
  host: {
    'role': 'datepicker',
    '[class.Custom-datepicker-disabled]': 'disabled',
    '[class.Custom-datepicker-opened]': 'opened',
...
export class CustomDatepicker implements OnDestroy, ControlValueAccessor {
  ...
  @Output() change: EventEmitter<CustomDateChange> = new EventEmitter<CustomDateChange>();
  ...
  id = `Custom-datepicker-${datepickerUid++}`;
  ...
  private _calendarPortal: ComponentPortal<CustomDatepickerContent>;
  ...
  private _minValidator: ValidatorFn = (control: AbstractControl): ValidationErrors | null => {
    return (!this.min || !control.value ||
      ...
      null : { 'CustomDatepickerMin': { 'min': this.min, 'actual': control.value } };
  }
  ...
  private coerceDateProperty(value: any): Date {
    ...
    let d: Date = v ? this._util.createDate(
      v.getFullYear(),
      v.getMonth(),
      v.getDate(),
      v.getHours(),
  ...
  _emitChangeEvent(): void {
    ...
    this.change.emit(new CustomDateChange(this, this.value));
  }
  ...
  open(): void {
    ...
    if (!this._calendarPortal) {
      this._calendarPortal = new ComponentPortal(CustomDatepickerContent, this._viewContainerRef);
    }
  ...
  private _openAsDialog(): void {
    ...
    if (!this._dialogRef.hasAttached()) {
      let componentRef: ComponentRef<CustomDatepickerContent> =
