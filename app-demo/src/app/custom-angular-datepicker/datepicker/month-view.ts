...
import { CustomCalendarCell } from './calendar-body';
...
export class CustomMonthView implements AfterContentInit {
  /**
  ...
  private _createWeekCells() {
    ...
    for (let i = 0, cell = this._firstWeekOffset; i < daysInMonth; i++ , cell++) {
      ...
      this._weeks[this._weeks.length - 1]
        .push(new CustomCalendarCell(i + 1, dateNames[i], ariaLabel, enabled));
    }
  }
